...
<div>
    {#each $commandLine as command, index}
        <div class="flex text-3xl font-bold items-center">
            ...
            <span class="flex items-center w-3/4">&nbsp;<input type="text" class="bg-inherit p-0 w-full border-0 text-2xl border-transparent focus:border-transparent focus:ring-0" bind:value={command}/></span>
        </div>
